    ...
    <ul>
        <li>
            ...
            <ul class="sub_menu" style="display:none">
                <li><a href="{{url('/admin/permission-list')}}"><i class="fa fa-fw fa-list-ul"></i>权限管理</a></li>
                <li><a href="{{url('/admin/role-list')}}"><i class="fa fa-fw fa-list-alt"></i>角色管理</a></li>
                <li><a href="{{url('/admin/user-list')}}"><i class="fa fa-fw fa-plus-square"></i>管理员管理</a></li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul class="sub_menu">
                <li><a href="{{url('/admin/album/userList')}}"><i class="fa fa-fw fa-list-ul"></i>用户专辑列表</a></li>
                <li><a href="{{url('/admin/picture/manager/1')}}"><i class="glyphicon glyphicon-picture"></i> 图片管理</a></li>
            </ul>
        </li>
        <li>
            <h3><i class="glyphicon glyphicon-leaf"></i>文章管理</h3>
            <ul class="sub_menu">
                <li><a href="{{url('admin/art/article')}}"><i class="fa fa-fw fa-list-ul"></i>用户文章列表</a></li>
                <li><a href="{{url('admin/art/artManage')}}"><i class="fa fa-fw fa-list-alt"></i>文章管理</a></li>
                <li><a href="{{url('admin/art/reviews')}}"><i class="glyphicon glyphicon-comment"></i>文章评论管理</a></li>
            </ul>
        </li>
    </ul>
</div>
