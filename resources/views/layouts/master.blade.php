...
<html>
	<head>
		...
		<script src="/js/home/album.js"></script>
		<script src="/js/home/picture.js"></script>
		<script src="/js/home/uploadFile.js"></script>

		<script>
			$(function(){
				$('#cateFirst').click(function(){
					$('#firstArea').empty();
					$.ajax({
						url:'/comUser/cateFirst',
						type:'get',
						success:function(data){
							$.each(data,function(k,v){
								$('#firstArea').append('<a href="/comUser/cateList/'+v.id+'/'+v.cateName+'" style="margin:10px;display:inline-block">'+v.cateName+'</a>');
			   				});
						}
					})
				})
						...
						<div id="header-wrap">
							<div id="dt-header">
								<div class="dt-wrap clearfix">
									...
									<!-- 网站头部 logo -->
									<a id="dt-logo" href="{{url('/')}}">堆糖</a>
									<!-- 一级分类区 -->
									<div id="dt-nav">
										<div id="dt-nav-btn-cover"></div>
										<div id="dt-nav-btn" class="dropdown">
											<span class="dropdown-toggle" data-toggle="dropdown" id="cateFirst">分类 <i></i></span>
											<div class="dropdown-menu" id="firstArea" style="width:232px;">
									...
									@if (Auth::check())
										...
										@include('layouts.addAlbum')
										@include('layouts.uploadImg')
									@else
