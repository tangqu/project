            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">{{$res['px']}}</td>
                        <td class="tc" style='width:150px'>
                            <a href="{{url('/admin/category/disEdit')}}/{{$res['id']}}/{{$res['display']}}" class="btn btn-default" style="margin-left:45px">{{$res['display'] == 0 ? '隐藏' : '显示'}}</a>
                        </td>
                        <td width="300px">        
                            <a href="{{url('/admin/category/add/')}}/{{$res['id']}}/{{$res['px']}}" class="btn btn-info" style='margin-left:1px'><span class="glyphicon glyphicon-th-large"></span> 添加子分类</a>
