...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('/admin/category/doAdd')}}" method="post">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                <tr>
                    ...
                    <td>
                       <input type="text" name='cateName' required></p>
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i>父级ID：</th>
                    <td>
                        <input type="text" name='pid' readonly value={{$pid}}>
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i>添加路径：</th>
                    <td>
                        <input type="text" name='path' readonly value={{$path}}>
                    </td>
                </tr>
                <tr>
                    <th>显示：</th>
                    <td>
                        ...
                        <label><input type='radio' name='display' value='0' checked>隐藏</label>
                    </td>
                </tr>
                <tr>
                    <th></th>
